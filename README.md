...
However, some important functions such as a function to handle vector tile data, will work only when you host index.html on a web server.
...
- gsimaps uses <a href='http://newspat.csis.u-tokyo.ac.jp/geocode/'>the service operated by CSIS, University of Tokyo</a>.
